    ...
    <View className="flex-1 bg-background">
      ...
      <View className="flex-row items-center justify-between border-b border-primary/20 py-2 px-4 bg-background/85 sticky top-0 z-10">
        <View className="flex-row items-center">
          ...
          >
            <Image source={{ uri: followUser.avatar }} className="w-10 h-10 rounded-full bg-background/80 mr-3 border border-muted-foreground/35" />
            <View>
      ...
      <ScrollView className="flex-1 px-4 py-4">
        ...
        <View className="flex-row items-end mb-4 max-w-[85%]">
          <Image source={{ uri: followUser.avatar }} className="w-8 h-8 rounded-full mr-2 border border-muted-foreground/15" />
          <View className="bg-background/80 rounded-2xl rounded-bl-sm p-3 border border-muted-foreground/15">
        ...
        <View className="flex-row items-end mb-4 self-end max-w-[85%] justify-end">
          <View className="bg-primary/90 rounded-2xl rounded-br-sm p-3">
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <View className="flex-row items-end px-3 py-3 bg-background border-t border-primary/20">
          <TouchableOpacity className="p-2 mr-1">
            <ImageIcon size={22} color={colors.primary} />
          </TouchableOpacity>
          <View className="flex-1 bg-background/80 rounded-full flex-row items-center px-4 py-1.5 border border-muted-foreground/35 mr-2">
            <TextInput
