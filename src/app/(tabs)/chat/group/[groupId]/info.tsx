  ...
  return (
    <ScrollView className="flex-1 bg-background px-4 pt-12" showsVerticalScrollIndicator={false}>
      ...
      <View className="flex-row gap-4 mb-8">
        <View className="flex-1 bg-background p-4 rounded-2xl border border-zinc-800 items-center">
      ...
      <View className="bg-background rounded-3xl border border-zinc-800 overflow-hidden mb-8">
