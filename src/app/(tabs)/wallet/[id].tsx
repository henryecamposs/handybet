  ...
  return (
    <ScrollView className="flex-1 bg-zinc-950 px-4 pt-12" showsVerticalScrollIndicator={false}>
      ...
      <View className="bg-gradient-to-br from-secondary/40 to-zinc-900 rounded-3xl p-6 border border-secondary/30 mb-8 relative overflow-hidden">
        ...
        <View className="flex-row items-center justify-between mb-6">
          <View className="flex-row items-center">
            ...
            <View>
              <Text className="text-zinc-100 font-bold">Taquilla La Imaginaria</Text>
              <Text className="text-secondary text-[10px] uppercase font-bold tracking-widest mt-0.5">Conectada via API</Text>
            </View>
          </View>
        </View>

        <Text className="text-zinc-400 text-xs font-bold uppercase mb-1">Balance Disponible</Text>
        <Text className="text-zinc-100 font-black text-4xl mb-1">450.00 <Text className="text-secondary text-2xl">Bs</Text></Text>
        <Text className="text-zinc-500 text-sm mb-8">Actualizado hace 2 mins</Text>
        ...
        <View className="flex-row gap-4">
          ...
          <TouchableOpacity className="flex-1 bg-zinc-800/80 py-3 rounded-xl flex-row items-center justify-center border border-zinc-700">
      ...
      <View className="flex-row flex-wrap gap-4 mb-8">
        <TouchableOpacity className="flex-1 bg-zinc-900 p-4 rounded-2xl border border-zinc-800 items-center justify-center hover:bg-zinc-800 transition-colors">
          <Text className="text-2xl mb-2">📊</Text>
          <Text className="text-zinc-100 font-bold text-xs text-center">Reporte de Caja</Text>
        </TouchableOpacity>
        <TouchableOpacity className="flex-1 bg-zinc-900 p-4 rounded-2xl border border-zinc-800 items-center justify-center hover:bg-zinc-800 transition-colors">
          <Text className="text-2xl mb-2">🎫</Text>
          <Text className="text-zinc-100 font-bold text-xs text-center">Pagar Tickets</Text>
        </TouchableOpacity>
        <TouchableOpacity className="flex-1 bg-zinc-900 p-4 rounded-2xl border border-zinc-800 items-center justify-center hover:bg-zinc-800 transition-colors">
          <Text className="text-2xl mb-2">🔄</Text>
          <Text className="text-zinc-100 font-bold text-xs text-center">Sincronizar</Text>
        </TouchableOpacity>
      </View>
      ...
      <View className="mb-8">
        <View className="flex-row items-center justify-between mb-4">
          <Text className="text-zinc-100 font-bold text-lg">Historial de Taquilla</Text>
          <TouchableOpacity>
        ...
        <View className="bg-zinc-900 rounded-2xl border border-zinc-800 overflow-hidden">
          ...
          <View className="p-4 border-b border-zinc-800/50 flex-row justify-between items-center">
            <View className="flex-row items-center">
              ...
              <View>
                <Text className="text-zinc-100 font-medium text-sm">Depósito en Efectivo</Text>
                <Text className="text-zinc-500 text-[10px]">Cajero: Joselin</Text>
              </View>
            </View>
          ...
          <View className="p-4 flex-row justify-between items-center">
            <View className="flex-row items-center">
              ...
              <View>
                <Text className="text-zinc-100 font-medium text-sm">Pago de Premio #459</Text>
                <Text className="text-zinc-500 text-[10px]">Ticket ganador Tripleta</Text>
              </View>
            </View>
            <Text className="text-zinc-100 font-bold">-350.00 Bs</Text>
          </View>
        </View>
      </View>
      <View className="h-16" />
