  ...
  return (
    <ScrollView className="flex-1 bg-background px-4 pt-12" showsVerticalScrollIndicator={false}>
      ...
      <View className="mb-6">
        ...
        <Text className="text-foreground text-sm mt-1">Gestiona tus fondos y taquillas.</Text>
      </View>

      {/* Carrusel de Mis Billeteras */}
      <View className="mb-8">
        <Text className="text-foreground font-bold text-lg mb-4">Tus Billeteras</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} className="flex-row">
          ...
          >
            ...
            <Text className="text-foreground font-bold text-sm text-center">Crear/Añadir</Text>
          </TouchableOpacity>
      ...
      {misBilleteras.length === 0 && (
        <View className="flex-1 items-center justify-center py-6 mb-8 border border-zinc-800 rounded-3xl border-dashed">
          ...
          <Text className="text-foreground text-sm text-center mt-2 max-w-[250px]">Crea o enlaza tu primera taquilla/billetera para comenzar a jugar.</Text>
        </View>
      )}
      ...
      <View className="bg-gradient-to-r from-zinc-800 to-zinc-900 rounded-3xl p-6 border border-zinc-700/50 mb-8 relative overflow-hidden">
        ...
        <View className="flex-row items-center mb-6">
          ...
          <Text className="text-foreground font-medium">Balance Total</Text>
        </View>

        <Text className="text-foreground font-black text-4xl mb-1">1,240.50 <Text className="text-primary text-2xl">Bs</Text></Text>
        <Text className="text-foreground text-sm mb-8">Saldo Global (Suma de todos los grupos)</Text>
        ...
        <View className="flex-row gap-4">
          ...
          <TouchableOpacity className="flex-1 bg-background/80 py-3 rounded-xl flex-row items-center justify-center border border-zinc-700">
      ...
      <View className="mb-8">
        <View className="flex-row items-center justify-between mb-4">
          <Text className="text-foreground font-bold text-lg">Saldos por Grupos</Text>
        </View>
        ...
        <View className="bg-background p-4 rounded-2xl border border-zinc-800 flex-row items-center justify-between mb-3 hover:bg-background/80/80 transition-colors">
          <View className="flex-row items-center">
            ...
            <View>
              ...
              <Text className="text-foreground text-sm">Apuestas y Sorteos</Text>
            </View>
          </View>
          <View className="items-end">
            <Text className="text-secondary font-bold text-lg">50.00 Bs</Text>
            <Text className="text-foreground text-xs mt-1">Disp. para jugar</Text>
          </View>
        </View>
        ...
        <View className="bg-background p-4 rounded-2xl border border-zinc-800 flex-row items-center justify-between mb-3 hover:bg-background/80/80 transition-colors">
          <View className="flex-row items-center">
            ...
            <View>
              ...
              <Text className="text-foreground text-sm">Hipismo</Text>
            </View>
          </View>
          <View className="items-end">
      ...
      <View className="mb-8">
        <View className="flex-row items-center justify-between mb-4">
          <Text className="text-foreground font-bold text-lg">Premios por Cobrar</Text>
          <TouchableOpacity>
        ...
        <View className="bg-background p-4 rounded-2xl border border-zinc-800 flex-row items-center justify-between hover:bg-background/80/80 transition-colors">
          <View className="flex-row items-center">
            ...
            <View>
              <Text className="text-foreground font-bold">La Imaginaria (API)</Text>
              <Text className="text-foreground text-sm">Premios acumulados</Text>
            </View>
          </View>
          <View className="items-end">
      ...
      <View className="mb-8">
        <View className="flex-row items-center justify-between mb-4">
          <Text className="text-foreground font-bold text-lg">Movimientos Recientes</Text>
          <TouchableOpacity>
        ...
        <View className="bg-background rounded-2xl border border-zinc-800 p-4">
          <View className="flex-row items-center justify-between mb-4 pb-4 border-b border-zinc-800/50">
            <View className="flex-row items-center">
              ...
              <View>
                <Text className="text-foreground font-medium">Recarga Exitosa</Text>
                <Text className="text-foreground text-xs">Hoy, 10:20 AM</Text>
              </View>
            </View>
          ...
          <View className="flex-row items-center justify-between">
            <View className="flex-row items-center">
              ...
              <View>
                <Text className="text-foreground font-medium">Pago Sorteo Animalitos</Text>
                <Text className="text-foreground text-xs">Ayer, 3:45 PM (Grupo: Animalitos VIP)</Text>
              </View>
            </View>
            <Text className="text-foreground font-bold">-50.00 Bs</Text>
          </View>
        </View>
      </View>
    </ScrollView>
