  ...
  return (
    <ScrollView className="flex-1 bg-zinc-950 px-4 pt-12" showsVerticalScrollIndicator={false}>
      ...
      <View className="flex-row items-center gap-2 mb-6">
        ...
        <View>
          <Text className="text-zinc-100 font-bold text-2xl">Crear Canal Oficial</Text>
          <Text className="text-zinc-400 text-sm mt-1">Registra tu empresa o consorcio autorizado.</Text>
        </View>
      </View>
      ...
      <View className="bg-zinc-900 rounded-3xl p-6 border border-zinc-800 mb-8">
        ...
        <View className="bg-secondary/10 border border-secondary/30 p-4 rounded-2xl mb-6 flex-row items-start">
          ...
          <View className="flex-1">
            ...
            <Text className="text-zinc-300 text-xs leading-relaxed">Los canales están destinados a entidades verificadas. Al registrar el canal, deberás esperar la aprobación del equipo de La Imaginaria.</Text>
          </View>
        </View>
        ...
        <View className="space-y-4 mb-8">
          <View>
            <Text className="text-zinc-400 font-bold text-xs uppercase mb-2">Nombre de la Empresa</Text>
            <TextInput
          ...
          <View>
            <Text className="text-zinc-400 font-bold text-xs uppercase mb-2">Registro de Información Fiscal (RIF)</Text>
            <TextInput
              placeholder="J-12345678-9"
              placeholderTextColor="#52525b"
              className="bg-zinc-800 text-zinc-100 p-4 rounded-xl border border-zinc-700 font-medium uppercase font-mono"
            />
          </View>

          <View>
            <Text className="text-zinc-400 font-bold text-xs uppercase mb-2">Descripción del Consorcio</Text>
            <TextInput
