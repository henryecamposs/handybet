...
export default function DashboardLayout() {
  ...
  return (
    <View className="flex-1 flex-row bg-zinc-950">
      ...
      <View className="w-64 border-r border-zinc-900 bg-zinc-900/40 p-6 justify-between hidden md:flex">
        <View>
          ...
          <View className="space-y-2">
            ...
            >
              <Text className={`font-black text-xs uppercase ${pathname.includes('/taquilla') ? 'text-secondary' : 'text-zinc-400'}`}>
                🎟 Procesar Ticket
              </Text>
            </TouchableOpacity>
            ...
            >
              <Text className={`font-black text-xs uppercase ${pathname.includes('/monetizacion-ads') ? 'text-secondary' : 'text-zinc-400'}`}>
                📢 Configuración Ads
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <TouchableOpacity
          ...
          className="bg-zinc-950 border border-zinc-850 p-4 rounded-xl items-center"
        >
