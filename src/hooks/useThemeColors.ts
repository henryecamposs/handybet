...
export const lightColors = {
  ...
  muted: 'oklch(0.939 0.025 147.778)',
  mutedForeground: 'oklch(0.446 0.025 147.449)',
  ...
  border: 'oklch(0.927 0.007 23.654)',
...
export const darkColors = {
  background: 'oklch(0.111 0.009 25.934)',
  foreground: 'oklch(0.991 0.002 23.598)',
  muted: 'oklch(0.219 0.035 146.196)',
  mutedForeground: 'oklch(0.756 0.022 147.75)',
  popover: 'oklch(0.127 0.01 25.934)',
  popoverForeground: 'oklch(1 0 180)',
  card: 'oklch(0.127 0.01 25.934)',
  cardForeground: 'oklch(1 0 180)',
  border: 'oklch(0.241 0.014 24.265)',
