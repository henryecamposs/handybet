...
- **`PostDetailView.tsx`:** Vista detallada de una publicación que se renderiza directamente en el contenedor central de la aplicación (sin usar modales emergentes o popups), integrando una caja de respuesta rápida y un listado de comentarios.
